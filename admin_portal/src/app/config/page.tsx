                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-1.5 cursor-pointer ${
                    config.geminiOnlineFallbackEnabled 
                      ...
                      : "bg-slate-200 dark:bg-[#14151F] hover:bg-slate-300 dark:hover:bg-[#202231] text-slate-700 dark:text-[#9499B0] border border-slate-300 dark:border-[#282A3D]"
                  }`}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div className="space-y-1">
                  <label className="font-bold text-slate-700 dark:text-[#9499B0] font-bold uppercase tracking-wider text-[10px]">
